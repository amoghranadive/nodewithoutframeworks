...
var server = (function() {
    ...
    var router = {
        ...
        'account/edit': handlers.accountEditHandler,
        ...
        'favicon.ico': handlers.faviconHandler,
        'public/*': handlers.publicHandler,
        'example/error': handlers.throwException,
    }
    ...
    function initServer() {
        ...
        var unifiedServer = function(req, res) {
            ...
            req.on('end', () => {
                ...
                chosenHandler = trimmedPath.indexOf('public/') != -1 ? handlers.publicHandler : chosenHandler;
                ...
                try {
                    ...
                    chosenHandler(data, function(statusCode, payload, contentType) {
                        processHandlerRseponse(res, method, trimmedPath, statusCode, payload, contentType);
                    });
                } catch (err) {
                    console.log(err);
                    processHandlerRseponse(res, method, trimmedPath, 500, {'error': 'Unknown error has occured.'}, 'json');
                }
    ...
    function processHandlerRseponse(res, method, trimmedPath, statusCode, payload, contentType) {
        ...
        } else if (contentType === 'favicon' || contentType === 'ico') {
